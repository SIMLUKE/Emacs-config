...
;;; Backup handling
(setq backup-directory-alist '(("." . "~/.emacs.default/backups")))
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(2048-game go-mode lsp-ui which-key vterm vscode-dark-plus-theme treemacs-all-the-icons projectile magit lsp-mode flycheck dashboard))
